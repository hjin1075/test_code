...
**Mock模拟接口场景，如果没有实际项目，则可以直接运行--->base/flask_service.py文件，然后在去运行run.py**
...
**5、如果不想自己编写测试用例文件，可以运行base目录下的new_testcase_tools.py文件，打开后填入相关参数**
   可以先点击接口调试，确认接口没问题，再点击生成测试用例文件
